<?php
   ...
   // methode de la page d'accueil
   	...
   	public function afficheAccueil($monarticle,$monArtPopulaire,$nbrIdees,$nbrClick,$plusLu, $plusPartage, $plusCommente,$sondageMois,$monIp) {
   		...
   		?>
<div class="row hidden-xs eureka-pub">
   <div class="col-lg-12">
      <video class="img-responsive" autoplay="autoplay" loop="loop">
         <source src="./video/eurekaApps.mp4" type="video/mp4">
         <p>Cet Navigateur ne support pas ce video.</p>
      </video>
   </div>
</div>
...
<aside class="col-md-4 visible-md visible-lg">
   ...
   <div class="panel panel-default">
      ...
      <div class="panel-body">
         <div class="fb-like col-lg-4 col-sm-12" data-href="https://www.facebook.com/pages/Journal-Eureka/1435830350024137" data-width="159" data-layout="button_count" data-action="like" data-share="false">
         </div>
         <!-- div partager par FACEBOOK-->                
         <script>
            (function(d, s, id) {
         ...
         <div class="twitter-share-button col-lg-6 col-sm-12">
            <!-- div partager par TWITTER-->
         ...
         <div class="col-lg-2 col-md-5">
            <!-- div partager par courriel-->
            <a href="mailto:jovam1624@gmail.com" class="btn btn-default btn-xs" role="button">
            <span class="glyphicon glyphicon-envelope"></span></a>
         </div>
         <div class="fb-like-box img-responsive" data-href="https://www.facebook.com/pages/Journal-Eureka/1435830350024137" data-colorscheme="light" data-show-faces="true" data-header="false" data-stream="false" data-show-border="false"></div>
      </div>
   </div>
</aside>
<!-- ici finit l'aside Reseaux sociaux-->
<!-- file actualit&eacute; -->
<aside class="col-md-4 visible-md visible-lg">
   <!-- ****** Modifications por le Fil d'actualit&eacute; par Vanessa ****** -->
   <div class="panel-group" id="accordion">
      <div class="panel">
         <div class="panel-heading">
            <h1 class="panel-title">
               <a class="titre-fil" data-toggle="collapse" data-parent="#accordion" href="#plusLu">LES PLUS LUS</a>
            </h1>
         </div>
            ...
            <div class="panel-body">
               <ul>
                  ...
                  <li>
                     ...
                     <p  class="datePublie col-xs-10 col-xs-offset-3"> publi&eacute; le <?php echo $article['art_date_soumis']?>
                     <p/>
                  </li>
                  <?php
                     }
      ...
      <div class="panel">
         <div class="panel-heading">
            <h1 class="panel-title">
               <a  class="titre-fil" data-toggle="collapse" data-parent="#accordion" href="#plusPartage">LES PLUS PARTAG&Eacute;S</a>
            </h1>
         </div>
      ...
      <div class="panel">
         <div class="panel-heading">
            <h1 class="panel-title">
               <a  class="titre-fil" data-toggle="collapse" data-parent="#accordion" href="#plusCommente">LES PLUS COMMENT&Eacute;S</a>
            </h1>
         </div>
...
<aside class="col-md-4 visible-md visible-lg">
   <div class="panel panel-default">
      <p class="small">Publicité</p>
      <div class="panel-body publicité">
         <video class="img-responsive" autoplay="autoplay" loop="loop">
            <source src="./video/googleGlass.mp4" type="video/mp4">
            <p>Cet Navigateur ne support pas ce video.</p>
         </video>
      </div>
   </div>
